...
$(document).ready(function(){
    ...
    var game6qty = 0;
    var game6Name = "NBA 2K21";
     //game7
    var game7cost = 59.99;
    $("#game7cost").html(`$${game7cost}`);
    var game7qty = 0;
    var game7Name = "SPIDER MAN";
    //game8
    var game8cost = 69.99;
    $("#game8cost").html(`$${game8cost}`);
    var game8qty = 0;
    var game8Name = "JEDI FALLEN ORDER";
    //game9
    var game9cost = 99.99;
    $("#game9cost").html(`$${game9cost}`);
    var game9qty = 0;
    var game9Name = "GOD OF WAR";
    //game10
    var game10cost = 59.99;
    $("#game10cost").html(`$${game10cost}`);
    var game10qty = 0;
    var game10Name = "CALL OF DUTY BLACK OPS";
    //game11
    ...
    $("#game4").on("click", function(){
        game4qty++;
        sessionStorage.setItem("game4qty_stored", game1qty);
        total += game4cost;
        $("#cart").append(`<tr><td>${game4Name}</td> <td>${1}</td> <td>${game4cost}</td></tr><br>`);
        $("#totalCost").html(`${total}`);
    });
    ...
    $("#game5").on("click", function(){
        game5qty++;
        total += game5cost;
        $("#cart").append(`<tr><td>${game5Name}</td> <td>${1}</td> <td>${game5cost}</td></tr><br>`);
        $("#totalCost").html(`${total}`);
    });
    ...
    $("#game6").on("click", function(){
        game6qty++;
        total += game6cost;
        $("#cart").append(`<tr><td>${game6Name}</td> <td>${1}</td> <td>${game6cost}</td></tr><br>`);
        $("#totalCost").html(`${total}`);
    });
    ...
    $("#game7").on("click", function(){
        ...
        sessionStorage.setItem("game1qty_stored", game1qty);
        total += game7cost;
        $("#cart").append(`<tr><td>${game7Name}</td> <td>${1}</td> <td>${game7cost}</td></tr><br>`);
        $("#totalCost").html(`${total}`);
    });
    ...
    $("#game8").on("click", function(){
        game8qty++;
        total += game8cost;
        $("#cart").append(`<tr><td>${game8Name}</td> <td>${1}</td> <td>${game8cost}</td></tr><br>`);
        $("#totalCost").html(`${total}`);
    });
    ...
    $("#game9").on("click", function(){
        game9qty++;
        total += game9cost;
        $("#cart").append(`<tr><td>${game9Name}</td> <td>${1}</td> <td>${game9cost}</td></tr><br>`);
        $("#totalCost").html(`${total}`);
    });
    
    $("#game10").on("click", function(){
        game10qty++;
        sessionStorage.setItem("game4qty_stored", game10qty);
        total += game10cost;
        $("#cart").append(`<tr><td>${game10Name}</td> <td>${1}</td> <td>${game10cost}</td></tr><br>`);
        $("#totalCost").html(`${total}`);
    });
    ...
    $("#game11").on("click", function(){
        game11qty++;
        total += game11cost;
        $("#cart").append(`<tr><td>${game11Name}</td> <td>${1}</td> <td>${game11cost}</td></tr><br>`);
        $("#totalCost").html(`${total}`);
    });
    ...
    $("#game12").on("click", function(){
        game12qty++;
        total += game12cost;
        $("#cart").append(`<tr><td>${game12Name}</td> <td>${1}</td> <td>${game12cost}</td></tr><br>`);
        $("#totalCost").html(`${total}`);
    });
